               ...
               <div class="image-container">
                 ...
                 <div class="details">
                    ...
                    <div class="stars-row">
                        ...
                        <span class="quantity"><img src="/Template/Tela_Principal/Imagens/estrelas_de_avaliacao.png" width="21%>${value.rating.count}</span>
                    </div>
                    <div class="price-row">
...
function details_produtos(id) {
  window.location.href = '/Template/detalhes.html/detalhes.html?id=' + id;
}